...
const ProfilePage = () => {
  ...
  return (
    <div className={`${darkMode ? "dark" : ""} transition-all duration-500`}>
      ...
      <div className='max-w-md mx-auto mt-15 mb-20'>
        <div className="w-full flex items-center justify-center">
          <Card className="bg-gradient-to-br from-indigo-50 to-white dark:from-zinc-800 dark:to-zinc-900 shadow-xl rounded-3xl p-1">
